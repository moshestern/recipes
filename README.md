...
2. מייצר/מכין את תמונת ה־WebP המתאימה.
3. אם חיבור ה־GitHub הפעיל תומך בהעלאת binary, מוסיף את התמונה ל־branch. אחרת הוא נותן למשתמש את הקובץ וה־path המדויק להעלאה ידנית ומשאיר את ה־PR ממתין לתמונה.
4. שומר על מוסכמות הנתונים והכתיבה של האתר.
5. מריץ את ה־validator.
6. יוצר Pull Request מסודר ל־GitHub.
...
אם ה־Agent לא יכול להעלות קובצי binary דרך החיבור הזמין ל־GitHub, העלאת קובץ ה־WebP עצמו היא השלב הידני היחיד; אין למזג מתכון חדש לפני שהתמונה נמצאת ב־branch.
